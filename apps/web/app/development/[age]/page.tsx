...
export default function AgePage({ params }: Props) {
  ...
  return (
    <main>
      <PageShell title={`${title} — Development`} subtitle={`Milestones, activities and recommended toys for ${title}`}>
        <div className="card p-4">
          ...
          <div className="text-muted mt-2">Simple, daily activities parents can do to support development.</div>

          <h3 className="font-extrabold mt-4">Recommended toys</h3>
          <div className="mt-2 grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 12 }}>
